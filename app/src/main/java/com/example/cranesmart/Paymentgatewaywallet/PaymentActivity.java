...
public class PaymentActivity extends BaseActivity implements View.OnClickListener, Adapterinterface {
...
//        amount_et.setFilters(new InputFilter[]{new DecimalDigitsInputFilter(7, 2)});
    ...
    private void setUpUserDetails() {
        ...
        SharedPreferences pref = getSharedPreferences(Sharedprefence.SharedprefenceName, Context.MODE_PRIVATE); // 0 - for private mode
         ...
         String amoun=pref.getString(Sharedprefence.Addwallet,"0");
    ...
    private void launchPayUMoneyFlow() {
        ...
        builder.setAmount(String.valueOf(amount))
                ...
                .setKey(merchant_Key)
                .setMerchantId(Sharedprefence.Merchant_Id);
...
//            payNowButton.setEnabled(true);
    ...
    private void  surl() {
        ...
        String amoun1=pref.getString(Sharedprefence.Addwallet,"0");
        String hashkey=pref.getString(Sharedprefence.Hashkey,"0");
        String tax=pref.getString(Sharedprefence.Taxid,"0");
        ...
        Log.d("surlresponse", "surl: "+merchant_Key);
                 Call<successpaymentpojo> call = service.payment(value1,amoun1,"success",tax,hashkey,firstname,merchant_Key,Sharedprefence.Productinfotopup,email);
 ...
 public void hash(){
     ...
     SharedPreferences pref = this.getSharedPreferences(Sharedprefence.SharedprefenceName, Context.MODE_PRIVATE);
     String value1 = pref.getString(Sharedprefence.UserID, "0");
     String amoun2=pref.getString(Sharedprefence.Addwallet,"0");
     ...
     call.enqueue(new Callback<paymentpojo>() {
         ...
         public void onResponse(Call<paymentpojo> call, Response<paymentpojo> response) {
             ...
             editor.putString(Sharedprefence.Hashkey,response.body().getData());
             Log.d(TAG, "onResponse: "+response.body().getData());
             Log.d(TAG, "onResponse: "+response.body().getTxnid());
             editor.putString(Sharedprefence.Taxid,response.body().getTxnid());
             editor.commit();
             editor.apply();
...
//                progressDialog.dismiss();
    ...
    private void Addresslist(){
        layoutManager = new LinearLayoutManager(PaymentActivity.this);
