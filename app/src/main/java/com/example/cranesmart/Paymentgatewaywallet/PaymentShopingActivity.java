...
import com.example.cranesmart.Activity.AddresslistActivity;
...
public class PaymentShopingActivity extends BaseActivity implements View.OnClickListener {
...
//        amount_et.setFilters(new InputFilter[]{new DecimalDigitsInputFilter(7, 2)});
    ...
    private void setUpUserDetails() {
        ...
        Log.d(TAG, "setUpUserDetails: "+amountshoping);
        email_et.setText(email);
        mobile_et.setText(mobil);
        amount_et.setText(amountshoping);
        launchPayUMoneyFlow();
        restoreAppPref();
                ...
                new AlertDialog.Builder(this)
                        ...
                        .setPositiveButton(android.R.string.ok, new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int whichButton) {
                                dialog.dismiss();
                                Intent i= new Intent(PaymentShopingActivity.this,AddresslistActivity.class);
                                startActivity(i);
                                finish();
                            }
                        }).show();
...
//            payNowButton.setEnabled(true);
    ...
    private void  surl() {
        ...
        String value = pref.getString("Orderid", "0");
        String email=pref.getString("email","0");
        String amoun1=pref.getString("amountaddress","0");
        String hashkey=pref.getString("hashkeyy","0");
        String tax=pref.getString("taxation","0");
        ...
        Call<JSONObject> call = service.paymentorder(value1,value,amoun1,"success",tax,hashkey,firstname,merchant_Key,"Cranesmart Product Purchase",email);
    ...
    private void  furl() {
        ...
        Call<JSONObject> call = service.failorder(value1,value,amoun1,"failed",tax);
        call.enqueue(new Callback<JSONObject>() {
            @Override
            public void onResponse(Call<JSONObject> call, Response<JSONObject> response) {
                progressDialog.dismiss();
