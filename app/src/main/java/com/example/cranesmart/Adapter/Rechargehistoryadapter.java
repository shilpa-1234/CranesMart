...
public class Rechargehistoryadapter extends RecyclerView.Adapter<Rechargehistoryadapter.ViewHolder> {
  ...
  String  TAG ="@@walletadapter";
    ...
    public void onBindViewHolder(final ViewHolder viewHolder, final int i) {
        Log.d(TAG, "onBindViewHolder: "+history.get(i).getDescription().toString());
        Log.d(TAG, "onBindViewHolder: "+history.get(i).getAmount().toString());
        Log.d(TAG, "onBindViewHolder: "+history.get(i).getDatetime().toString());
