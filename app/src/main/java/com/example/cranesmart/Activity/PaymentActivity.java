...
import com.example.cranesmart.paymentgateway.AppPreference;
import com.example.cranesmart.paymentgateway.BaseActivity;
import com.example.cranesmart.paymentgateway.BaseApplication;
...
public  class PaymentActivity extends BaseActivity  implements View.OnClickListener {
    ...
    private EditText email_et, mobile_et, amount_et,title;
...
//        toolbar.setTitle(getString(R.string.app_name));
        ...
        title=findViewById(R.id.activity_title_et);
        ...
        SharedPreferences pref = getSharedPreferences("MyPref", Context.MODE_PRIVATE); // 0 - for private mode
          String value= pref.getString("amount","0");
          String mail=pref.getString("email","0");
          String mobile=pref.getString("mobile","0");
          String address= pref.getString("add","0");
          String addres= pref.getString("address","0");
          title.setText(address);
          title.setText(addres);
          mobile_et.setText(mobile);
          amount_et.setText(value);
          email_et.setText(mail);
        launchPayUMoneyFlow();
...
//                    launchPayUMoneyFlow();
    ...
    private void launchPayUMoneyFlow() {
        ...
        SharedPreferences pref = getSharedPreferences("MyPref", Context.MODE_PRIVATE); // 0 - for private mode
         String address= pref.getString("","0");
