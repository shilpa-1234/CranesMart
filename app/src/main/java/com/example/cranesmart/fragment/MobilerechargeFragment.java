...
//                alertDialog.getWindow().setBackgroundDrawableResource(R.drawable.bg_rounded_button);
    ...
    public void recharge(){
        ...
        APIService service = retrofit.create(APIService.class);
        Call<Rechargepojo> call = service.recharge(userid,Sharedprefence.RechargeType,mobile,Sharedprefence.Prepaid,operator,circlecode,amount);
    ...
    public void rechargepostpaid(){
        ...
        APIService service = retrofit.create(APIService.class);
        Call<Rechargepostpojo> call = service.rechargepost(userid,Sharedprefence.RechargeType,mobile,Sharedprefence.Postpaid,operator,circlecode,amount,Acnumer);
